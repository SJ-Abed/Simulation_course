...
def simulation(simulation_time , Expert_mean_service_time = tt(min= 3), Beginner_mean_service_time = tt(min= 7),max_Experts = 2 , max_Technician = 2,max_Beginner =3):
    ...
    state, future_event_list, data = starting_state(Expert_mean_service_time,max_Experts, Beginner_mean_service_time  , max_Technician,max_Beginner)
    clock = 0
    ...
    KPI['Queue stats']['average length'][1] = data['Cumulative Stats']['Area Under Queue1 Length Curve']/simulation_time
    KPI['Queue stats']['average length'][2] = data['Cumulative Stats']['Area Under Queue2 Length Curve']/simulation_time
    KPI['Queue stats']['average length'][3] = data['Cumulative Stats']['Area Under Queue3 Length Curve']/simulation_time
    KPI['Queue stats']['average length'][4] = data['Cumulative Stats']['Area Under Queue4 Length Curve']/simulation_time
    KPI['Queue stats']['average length'][5] = data['Cumulative Stats']['Area Under Queue5 Length Curve']/simulation_time
    KPI['Queue stats']['average length'][6] = data['Cumulative Stats']['Area Under Queue6 Length Curve']/simulation_time
    ...
    KPI['Efficiency']['Beginners'] = data['Cumulative Stats']['Beginner Busy Time'] / (simulation_time*max_Beginner)
    KPI['Efficiency']['Experts'] = data['Cumulative Stats']['Expert Busy Time'] / (simulation_time*max_Experts)
    KPI['Efficiency']['Technician'] = data['Cumulative Stats']['Technician Busy Time'] / (simulation_time*max_Technician)
